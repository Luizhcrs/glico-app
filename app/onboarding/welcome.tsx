...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: theme.fontSizes.lg, fontWeight: '700', color: theme.colors.text, letterSpacing: 1 },
  center: { gap: theme.spacing.md, alignItems: 'center', paddingHorizontal: theme.spacing.md },
  title: { fontSize: 28, fontWeight: '700', color: theme.colors.text, textAlign: 'center', lineHeight: 34 },
  body: {
    fontSize: theme.fontSizes.md, color: theme.colors.textMuted,
    textAlign: 'center', lineHeight: 22, maxWidth: 320,
  },
  bottom: { gap: theme.spacing.md, alignItems: 'center' },
  privacy: { fontSize: theme.fontSizes.xs, color: theme.colors.textMuted, textAlign: 'center' },
});
